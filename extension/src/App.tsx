          ...
          <div className="flex items-center gap-3">
            {isRecording && (
              <div className="flex items-center gap-2 px-2 py-1 bg-blue-500/20 rounded-lg border border-blue-500/30">
                ...
                <span className="text-[9px] font-bold text-blue-300 uppercase tracking-wider">Sharing</span>
              </div>
            )}
                ...
                >
                  {isEnding ? (
                    ...
                    <>
                      ...
                      <span className="text-sm font-bold tracking-widest">START</span>
                    </>
                  )}
                </button>
                {/* Subtle Glow Effect */}
                <div className={`absolute -inset-4 rounded-full blur-2xl opacity-20 -z-10 transition-colors duration-500 ${isRecording ? "bg-red-500" : "bg-indigo-500"}`}></div>
              </div>
              ...
              <div className="flex flex-col gap-4 w-full">
                ...
                {!isRecording && (
                  <div className="w-full space-y-1">
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider ml-1">Select Mission</label>
                    {isCreating ? (
                ...
                {/* Audio Input */}
                <div className="w-full space-y-1">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider ml-1">Input Source</label>
                  <div className="flex items-center gap-2 w-full">
                    <button
                      onClick={toggleAudio}
